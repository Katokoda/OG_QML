...
Rectangle {
    ...
    ParallelAnimation {
        ...
        // SpringAnimation { id: backAnimX; target: activity; property: "x"; duration: 500; spring: 2; damping: 0.2 }
        // SpringAnimation { id: backAnimY; target: activity; property: "y"; duration: 500; spring: 2; damping: 0.2 }
    }
}
